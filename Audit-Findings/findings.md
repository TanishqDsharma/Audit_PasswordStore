...
### [S-#] `PasswordStore::setPassword` has no access control, meaning a non-owner can change the password

**Description:** The `PasswordStore::setPassword` function is set to be an `external` function, however the natspec of the function and overall purpose of smartcontract is that  `This function allows only owner to set a new password.`
...
**Recommended Mitigations** Add an access control modifier to the `setPassword` function. 
